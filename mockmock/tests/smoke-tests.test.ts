...
import { AnyObject, JSONObject } from '../types';

const MM = Mockmock.instance;
const fixtureDir = './mock-mock/tests/fixtures/';
const tempDir = './dist/';
...
test('it can write a fixture to disk', async () => {
...
test('it can search the current context for a mock', async () => {
